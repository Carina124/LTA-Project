twoafri = total_LR_plot_vector3
twoafri_n = total_LR_plot_vector_non3

plot.new()
par(mfrow=c(2,2))
hist(twoafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (2P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
hist(twoafri_n, breaks=seq(from=-1,to=20,by=1), col=rgb(0,0,1,0.5), ylim=c(0,0.9), prob = TRUE, add=T)
box()
################################3 person mix############################################
...
hist(threeafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (3P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
...
hist(fourafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (4P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
...
hist(fiveafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (5P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
...
hist(sixafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (6P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
...
hist(sevafri, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (7P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
...
hist(eiapa, breaks=seq(from=-1,to=25,by=1), col=rgb(1,0,0,0.5), prob = TRUE, ylim=c(0,1.0),
     main="False Postive (8P Mix Afri)", xlab="Likelihood Ratio (Log10)",ylab = "Frequency")
