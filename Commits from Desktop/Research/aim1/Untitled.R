...
{
  set.seed(657)
  allelefreq_tbl <- read.csv("USAf.1_new.csv")    
  pop_freq <- tabfreq(tab=allelefreq_tbl, pop.names=as.factor('population'))
  popgeno <- simugeno(tab=pop_freq, n=100, which.loc = c("CSF1PO","D3S1358","D5S818","D7S820","D8S1179",
...
LRs = total_contrib_function("USAf.1_new.csv", 10, 2, 20, 0)
