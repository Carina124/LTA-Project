...
write.csv(A_true.array_3d,"A_truecontrib.array.csv")
...
write.csv(A_non.contrib.fpr.array,"A_non.contrib.fpr.array.csv")
...
write.csv(non.contrib.ave.fpr_mat, "A_non.contrib.ave.fpr_mat.csv")
